...
!#define DEBUG
   ...
   interface fio_read
      ...
      module procedure fio_read_logical_2darray
...
! 2: field name not found
   ...
   ! read real8
   subroutine fio_read_str(unitid, fieldname, vardata, errcode)
      implicit none
      ! input
      integer,                        intent(in)              :: unitid
      character(len=*),       intent(in)              :: fieldname
   ...
   subroutine fio_read_logical_2Darray(unitid, fieldname, vardata, errcode)
      implicit none
      ! input
      integer,                        intent(in)              :: unitid
      character(len=*),       intent(in)              :: fieldname
   ...
   end subroutine fio_read_logical_2Darray
