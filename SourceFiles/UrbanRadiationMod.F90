...
#ifndef _OPENACC
         !#py write(iulog,*) 'urban incident atmospheric longwave radiation balance error',err
         !#py write(iulog,*) 'l          = ',l
         !#py write(iulog,*) 'lwdown     = ',lwdown
         !#py write(iulog,*) 'vf_sr      = ',vf_sr(l)
         !#py write(iulog,*) 'vf_sw      = ',vf_sw(l)
         !#py write(iulog,*) 'canyon_hwr = ',canyon_hwr
