...
contains
  ...
  subroutine ComputeHeatNonLake(bounds, num_nolakec, filter_nolakec, &
    ...
    real(r8) :: h2ocan_col(1:num_nolakec)  ! canopy water (mm H2O)
   !  real(r8) :: snocan_col(bounds%begc:bounds%endc)  ! canopy snow water (mm H2O)
    real(r8) :: liqcan        ! canopy liquid water (mm H2O)

    real(r8) :: heat_dry_mass(1:num_nolakec) ! sum of heat content: dry mass [J/m^2]
    real(r8) :: heat_ice(1:num_nolakec)      ! sum of heat content: ice [J/m^2]
    real(r8) :: latent_heat_liquid(1:num_nolakec) ! sum of latent heat content of liquid water [J/m^2]
